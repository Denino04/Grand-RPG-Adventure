...
const QUESTS = {
    ...
    'dragon_slayer': { title: 'Dragon Slayer', type: 'fetch', target: 'dragon_scale', required: 5, reward: {xp: 1000, gold: 250}, description: 'Slay the flying serpent and acquire its scales.'}
};
